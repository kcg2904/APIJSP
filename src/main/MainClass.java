...
//		ArrayList<NaverDTO> list = nd.select();
//		System.out.println(nd.select());
//		for (NaverDTO to : list){
//			System.out.println(to.getTitle());
//			System.out.println(to.getOriginallink());
//			System.out.println(to.getLink());
//			System.out.println(to.getDescription());
//			System.out.println(to.getPubDate());
//		}
	}		
}
